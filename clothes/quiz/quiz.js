/* ========================================
   Finnish Clothes & Colors Quiz - JavaScript
======================================== */
...
class ClothesQuiz {
  ...
  displayQuestion() {
    ...
    this.displayClothesVisual(question);
  ...
  displayClothesVisual(question) {
    const clothesComponent = document.getElementById("clothesComponent");
    const clothesIcon = document.getElementById("clothesIcon");
    const clothesWord = document.getElementById("clothesWord");
    const colorSwatch = document.getElementById("colorSwatch");

    // Reset classes
    clothesComponent.className = "clothes-component";
    ...
    for (const [word, emoji] of Object.entries(this.clothesIcons)) {
    ...
    // Default for different subtopics
    if (!displayWord) {
      if (question.subtopic === "colors") {
        icon = "🎨";
        displayWord = "väri";
      } else if (question.subtopic === "plural") {
        icon = "👖";
        displayWord = "monikko";
      } else if (question.subtopic === "sentences") {
        icon = "💬";
        displayWord = "lause";
      } else {
        displayWord = "vaate";
    ...
    clothesIcon.textContent = icon;
    clothesWord.textContent = displayWord;

    if (showColor && colorHex) {
      colorSwatch.style.backgroundColor = colorHex;
      colorSwatch.classList.add("visible");
    }

    clothesComponent.classList.add(question.subtopic);
  }
