/* ========================================
   Finnish Months Quiz - JavaScript
======================================== */
...
class MonthsQuiz {
  ...
  displayQuestion() {
    ...
    // Display month visual based on question
    this.displayMonthVisual(question);
  ...
  displayMonthVisual(question) {
    const monthComponent = document.getElementById("monthComponent");
    const monthDisplay = document.getElementById("monthDisplay");
    const seasonBadge = document.getElementById("seasonBadge");

    // Reset classes
    monthComponent.className = "month-component";
    ...
    if (monthData) {
      ...
      // Default display for questions without specific month
      monthDisplay.textContent = "📅";
      seasonBadge.textContent = "kuukaudet";
    }
  }

  getMonthFromQuestion(question) {
    if (!this.vocabulary.months) return null;

    // Try to find a month mentioned in the question or correct answer
